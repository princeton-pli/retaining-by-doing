...
dataset_name="IFEvalOnPolicyDataset"
#dataset_name="MMLUOnPolicyDataset"
#dataset_name="CountdownOnPolicyDataset"
###############################################################################
...
# Set batch size and gradient accumulation based on dataset
if [[ "${dataset_name}" == "CountdownOnPolicyDataset" ]]; then
